...
const GenerateImages = () => {
  const imageStyle = [ 'Realistic','Ghibli style','Anime style', 'Cartoon', '3D Render', 'Pixel Art', 'Line Art', 'Watercolor', 'Oil Painting', 'Surreal', 'Fantasy', 'Cyberpunk']
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200' action="">
        ...
        className='w-full p-2 px-3 mt-2 outline-non text-sm rounded-md border border-gray-300' 
        ...
        <div className='my-6 flex items-center gap-2'>
          <label className='relative cursor-pointer'>
            ...
            <div className='w-9 h-5 bg-slate-300 rounded-full peer-checked:bg-green-300 transition'></div>
        ...
        <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-linear-to-r from-[#00AD25] to-[#04FF50]
